...
(def ^:private portable
  [[['a 'b] '(+ a b)]
   ...
   ;; memwidth: four transfer widths by four window tiers. A gap on one ISA
   ;; at one width would be silent without this list.
   ...
   [['b 'l 'i 'v] '(kernel-store-u8-16k b l i v)]
   [['b 'l 'i] '(kernel-load-u8-64k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u8-64k b l i v)]
   [['b 'l 'i] '(kernel-load-u16 b l i)]
   [['b 'l 'i 'v] '(kernel-store-u16 b l i v)]
   [['b 'l 'i] '(kernel-load-u16-4k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u16-4k b l i v)]
   [['b 'l 'i] '(kernel-load-u16-16k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u16-16k b l i v)]
   [['b 'l 'i] '(kernel-load-u16-64k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u16-64k b l i v)]
   [['b 'l 'i] '(kernel-load-u32 b l i)]
   [['b 'l 'i 'v] '(kernel-store-u32 b l i v)]
   [['b 'l 'i] '(kernel-load-u32-4k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u32-4k b l i v)]
   [['b 'l 'i] '(kernel-load-u32-16k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u32-16k b l i v)]
   [['b 'l 'i] '(kernel-load-u32-64k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u32-64k b l i v)]
   [['b 'l 'i] '(kernel-load-u64 b l i)]
   [['b 'l 'i 'v] '(kernel-store-u64 b l i v)]
   [['b 'l 'i] '(kernel-load-u64-4k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u64-4k b l i v)]
   [['b 'l 'i] '(kernel-load-u64-16k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u64-16k b l i v)]
   [['b 'l 'i] '(kernel-load-u64-64k b l i)]
   [['b 'l 'i 'v] '(kernel-store-u64-64k b l i v)]
   ;; memwidth: the ADR 0285 slice family. Element-indexed, and the
   ;; ceiling is an address-space bound, but nothing about that is
   ;; per-ISA -- both backends scale the index in the addressing mode.
   [['b 'l 'i] '(slice-load-u8 b l i)]
   [['b 'l 'i 'v] '(slice-store-u8 b l i v)]
   [['b 'l 'i] '(slice-load-u16 b l i)]
   [['b 'l 'i 'v] '(slice-store-u16 b l i v)]
   [['b 'l 'i] '(slice-load-u32 b l i)]
   [['b 'l 'i 'v] '(slice-store-u32 b l i v)]
   [['b 'l 'i] '(slice-load-u64 b l i)]
   [['b 'l 'i 'v] '(slice-store-u64 b l i v)]
